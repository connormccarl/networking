  ...
  return (
    <>
        <footer className="container">
            ...
            <p>&copy; { new Date().getFullYear() } Networking Group &middot; <button type="button" class="btn btn-link p-0 align-baseline" onClick={showModal}>Code of Conduct</button></p>
        </footer>
        <div class="modal fade" id="pageModal" tabindex="-1" aria-labelledby="pageModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="pageModalLabel">Modal title</h1>
